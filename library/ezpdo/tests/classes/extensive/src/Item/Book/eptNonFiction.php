...
/**
 * $Id: eptNonFiction.php 773 2006-01-25 11:52:21Z nauhygon $
 * 
 ...
 * @subpackage ezpdo_t.bookstore
 */
class eptItemBookNonFiction extends eptItemBook {
    
    /**
     * Reviewers of the book
     * @orm has one eptReviewer inverse(books)
     */
    public $reviewer;
    
    public function __construct() {
        parent::__construct(eptItemBook::NONFICTION);
    }
