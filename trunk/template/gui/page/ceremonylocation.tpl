...
<script type="text/javascript">
  <!--
    ...
    function init() {
      ...
      var gui = AbstractCeremonyLocation.gui('{{$template|escape:javascript}}');
      new HandleCeremonyLocation(gui, MiscUtils.decode('{{$operator|escape:javascript}}'), MiscUtils.decode('{{$now|escape:javascript}}'), MiscUtils.decode('{{$options|escape:javascript}}'));
    }
  //-->
</script>
