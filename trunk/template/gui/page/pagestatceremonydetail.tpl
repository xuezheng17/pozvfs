...
<script type="text/javascript">
  <!--
    ...
    function init() {
      ...
      var gui = AbstractPageStatCeremonyDetail.gui('{{$template|escape:'javascript'}}');
      new HandlePageStatCeremonyDetail(gui, JSON.parse('{{$operator|escape:javascript}}'), JSON.parse('{{$now|escape:javascript}}'), JSON.parse('{{$options|escape:javascript}}'));
    }
  //-->
</script>
