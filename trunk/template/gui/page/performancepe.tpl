...
<script type="text/javascript">
  <!--
    ...
    function init() {
      ...
      new HandlePerformancePE(gui, MiscUtils.decode('{{$operator|escape:javascript}}'), MiscUtils.decode('{{$now|escape:javascript}}'), MiscUtils.decode('{{$options|escape:javascript}}'));
    }
  //-->
</script>
    ...
    <td class="{{$template|escape:'html'}}_td5">
      <table class="{{$template|escape:'html'}}_table2" id="{{$template|escape:'html'}}_mains_table" cellPaddiing="0" cellSpacing="0">
        <tr>
          ...
          <td class="{{$template|escape:'html'}}_td8">Visited Customers</td>
