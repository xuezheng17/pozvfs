      ...
      <table class="{{$template|escape:'html'}}_table3" cellPaddiing="0" cellSpacing="0"border=0>
        <tr>
          <td class="{{$template|escape:'html'}}_td7">
            <a id="{{$template|escape:'html'}}_addTemplate_button">Create new eTemplate</a>
          </td>
        </tr>
      </table>
      <table class="{{$template|escape:'html'}}_table2" id="{{$template|escape:'html'}}_templates_table" cellPaddiing="0" cellSpacing="0">
        <tr>
          <td class="{{$template|escape:'html'}}_td3">Name</td>
          <td class="{{$template|escape:'html'}}_td4">Content</td>
