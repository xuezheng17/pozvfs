...
<script type="text/javascript">
  <!--
    ...
    function init() {
      ...
      var gui = AbstractCulturalBackground.gui('{{$template|escape:javascript}}');
      new HandleCulturalBackground(gui, MiscUtils.decode('{{$operator|escape:javascript}}'), MiscUtils.decode('{{$now|escape:javascript}}'), MiscUtils.decode('{{$options|escape:javascript}}'));
    }
  //-->
</script>
...
<table class="{{$template|escape:'html'}}_table1" cellPaddiing="0" cellSpacing="0" border=0>
  <tr>
    <td class="{{$template|escape:'html'}}_td0" colSpan="3" >Cultural Background</td> 
  </tr>
  <tr>
