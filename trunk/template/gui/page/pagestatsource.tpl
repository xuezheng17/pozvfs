...
<script type="text/javascript">
  <!--
    ...
    function init() {
      ...
      var gui = AbstractPageStatSource.gui('{{$template|escape:javascript}}');
      var options = { template: '{{$template|escape:'javascript'}}', option: '{{$options|escape:javascript}}' };
      new HandlePageStatSource(gui, MiscUtils.decode('{{$operator|escape:javascript}}'), MiscUtils.decode('{{$now|escape:javascript}}'), options);
    }
  //-->
</script>
