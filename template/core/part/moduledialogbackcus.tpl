function ModuleDialogBackCus(doc, container, width, height, operator, now, options) {
  this._doc = doc;
  ...
  this._gui = new DialogBackCus(this._doc, this._container, this._width, this._height, this._operator, this._now, this._options)._gui;
  this._createElements();
};

ModuleDialogBackCus.prototype._createElements = function() {
  var _self = this;
//  console.log(this._gui);
  this._loadData();
};

ModuleDialogBackCus.prototype._loadData = function() {
  this._results = null;
  this._retrieveResults();
};

ModuleDialogBackCus.prototype._verifyData = function() {
  if (this._results) {
    this._updateElements();
  }
};

ModuleDialogBackCus.prototype._retrieveResults = function() {
  var _self = this;
  var args = {cond: 'd.culturalBackground=\'' + this._options.name + '\''};
  new RequestUtils()._custom('statculturecustomers', args, function(result, params) { _self._results = result;
                                                                                          _self._verifyData.call(_self);
                                                                                        }, null);
};

ModuleDialogBackCus.prototype._updateElements = function() {
  var _self = this;
