function ModuleDialogCereCus(doc, container, width, height, operator, now, options) {
  this._doc = doc;
  ...
  this._gui = new DialogCereCus(this._doc, this._container, this._width, this._height, this._operator, this._now, this._options)._gui;
  this._createElements();
};

ModuleDialogCereCus.prototype._createElements = function() {
  var _self = this;
//  console.log(this._gui);
  this._loadData();
};

ModuleDialogCereCus.prototype._loadData = function() {
  this._results = null;
  this._retrieveResults();
};

ModuleDialogCereCus.prototype._verifyData = function() {
  if (this._results) {
    this._updateElements();
  }
};

ModuleDialogCereCus.prototype._retrieveResults = function() {
  var _self = this;
...
ModuleDialogCereCus.prototype._updateElements = function() {
  var _self = this;
