...
HandleStatBasic.prototype._retrieveVisitor = function(page, condition, from, to) { 
  var _self = this;
  var args = ((condition) ? '&c=' + condition : '') + '&p=' + page + '&s=99999' + '&from=' + ((from) ? from : '' ) + '&to=' + ((to) ? to : '');
  new RequestUtils()._mysql('statBasic', args, function(result, params) { _self._visitor = result.data[0];
                                                                                _self._verifyData.call(_self);
                                                                              }, null);
};

HandleStatBasic.prototype._retrieveDateZones = function() {
  var _self = this;
...
HandleStatBasic.prototype._visitorSearch = function(gui, callbackFunc) {
  var _self = this;
 ...
 * 修改日期1Change
 */
HandleStatBasic.prototype._changeDate = function(label, currentDate, onChangeFunc, showTime) {
  var div, _self = this;
 ...
 * 修改日期2Select
 */
HandleStatBasic.prototype._selectDate = function(sd, label, onChangeFunc, showTime) {
  onChangeFunc(sd);
 ...
 * 修改日期3Show
 */
HandleStatBasic.prototype._showDate = function(sd, label, showTime) {
  if (sd) { 
