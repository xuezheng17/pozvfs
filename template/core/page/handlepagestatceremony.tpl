...
HandlePageStatCeremony.prototype._retrieveDateZones = function() {
  var _self = this;
...
HandlePageStatCeremony.prototype._updateElements = function() {
  ...
  for (var i = 0, il = this._results.length; i < il; i++) {
    ...
    a.onclick = function() { var pos, func1;
                             ...
                             new ModuleDialogCereCus(document, tmp._gui.panel, 300, 30, _self._operator, _self._now, { popupBox: tmp, pos: DOMUtils.findPos(this), name: this._name});
                             return false;
                           };
td.appendChild(a);
  }
...
this._customerSearch(this._gui, function(condition, from, to) { _self._retrieveResults.call(_self, 1, condition, from, to); });
  ...
  HandlePageStatCeremony.prototype._customerSearch = function(gui, callbackFunc) {
  var _self = this;
...
HandlePageStatCeremony.prototype._changeDate = function(label, currentDate, onChangeFunc, showTime) {
  var div, _self = this;
...
HandlePageStatCeremony.prototype._selectDate = function(sd, label, onChangeFunc, showTime) {
  onChangeFunc(sd);
  this._showDate(sd, label, showTime);
  this._popupBox._close();
};

HandlePageStatCeremony.prototype._showDate = function(sd, label, showTime) {
  if (sd) { 
