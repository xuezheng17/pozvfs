function HandlePageStatSource(gui, operator, now, options) {
  this._gui = gui;
...
HandlePageStatSource.prototype._loadData = function() {
  this._results = null;
...
HandlePageStatSource.prototype._verifyData = function() {
...
//  ChartUtils.source(this._gui.detail.graph, this._results);
  ...
  for (var i = 0, il = this._results.length; i < il; i++) {
    ...
    a.onclick = function() { var pos, func1;
                             ...
                             new ModuleDialogSourCus(document, tmp._gui.panel, 300, 30, _self._operator, _self._now, { popupBox: tmp, pos: DOMUtils.findPos(this),name:this. _name });
                             return false;
                           };
    td.appendChild(a);
  }
...
HandlePageStatSource.prototype._showDate = function(sd, label, showTime) {
  if (sd) { 
