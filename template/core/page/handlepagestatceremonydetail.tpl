function HandlePageStatCeremonyDetail(gui, operator, now, options) {
  this._gui = gui;
...
HandlePageStatCeremonyDetail.prototype._createElements = function() {
  var _self = this;
  
  this._loadData();
};

HandlePageStatCeremonyDetail.prototype._loadData = function() {
  this._results = null;
  this._retrieveResults();
};

HandlePageStatCeremonyDetail.prototype._verifyData = function() {
  if (this._results) {
...
HandlePageStatCeremonyDetail.prototype._updateElements = function() {
  var _self = this;
