...
<script type="text/javascript">
  <!--
    ...
    function init() {
      ...
      new HandleStatistics(gui, MiscUtils.decode('{{$operator|escape:javascript}}'), MiscUtils.decode('{{$now|escape:javascript}}'), options);
    }
  //-->
</script>
          ...
          <td class="{{$template|escape:'html'}}_td5" colSpan="6">
            <table class="{{$template|escape:'html'}}_table2" cellPaddiing="0" cellSpacing="0">
              ...
              <tr>
                ...
                <td class="{{$template|escape:'html'}}_td9" id="{{$template|escape:'html'}}_visit_div"> </td>
                <td class="{{$template|escape:'html'}}_td9" id="{{$template|escape:'html'}}_noVisit_div"></td>
              </tr>
            </table>
          </td>
        </tr>
        <tr>
          <td style="height:530px" id="{{$template|escape:'html'}}_graphy_div" colSpan="6"></td>
      </table>
    </td>
