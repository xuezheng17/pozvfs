function DialogBackCus(doc, container, width, height, operator, now, options) {
  this._doc = doc;
  ...
  this._gui = AbstractDialogBackCus.gui(this._unique, this._doc);
};

DialogBackCus.prototype._createElements = function() {
