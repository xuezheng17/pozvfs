function DialogCereCus(doc, container, width, height, operator, now, options) {
  this._doc = doc;
  ...
  this._gui = AbstractDialogCereCus.gui(this._unique, this._doc);
};

DialogCereCus.prototype._createElements = function() {
