function DialogSourCus(doc, container, width, height, operator, now, options) {
  this._doc = doc;
  ...
  this._gui = AbstractDialogSourCus.gui(this._unique, this._doc);
};

DialogSourCus.prototype._createElements = function() {
