...
{{include file='include/_database/pz_ireverse.class.tpl'}}
...
{{include file='api/part/abstractdialoghistory.tpl'}}
{{include file='gui/part/dialoghistory.tpl'}}
{{include file='core/part/moduledialoghistory.tpl'}}
