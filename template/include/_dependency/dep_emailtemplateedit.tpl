...
{{include file='include/_database/pz_emailtemplate.class.tpl'}}
...
{{include file='core/page/handleemailtemplateedit.tpl'}}
{{include file='api/page/abstractemailtemplateedit.tpl'}}
