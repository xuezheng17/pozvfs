{{include file='api/page/abstractpagestatsource.tpl'}}
{{include file='api/part/abstractdialogsourcus.tpl'}}
...
{{include file='gui/part/dialogsourcus.tpl'}}
...
{{include file='core/part/moduldialogsourcus.tpl'}}
...
{{include file='core/page/handlepagestatsource.tpl'}}
